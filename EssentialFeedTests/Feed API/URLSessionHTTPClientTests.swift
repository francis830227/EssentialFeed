...
//  EssentialFeedTests
//
//  Created by Kai-Ping Tseng on 2022/4/18.
//
...
class URLSessionHTTPClientTests: XCTestCase {
    ...
    func test_getFromURL_successesOnHTTPURLResponseWithData() {
        let data = anyData()
    ...
    func test_getFromURL_successesWithEmptyDataOnHTTPURLResponseWithNilData() {
        let response = anyHTTPURLResponse()
